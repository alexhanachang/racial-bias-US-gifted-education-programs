...
RE_sex <- enroll %>% 
  ...
  select(COMBOKEY, state, 
         ...
         gat_bipoc_m, bipoc_m, gat_bipoc_f, bipoc_f, 
...
## Tidy --------------------------------------------------------------------
REsexy <- RE_sex %>% 
  unite(asian_m, gat_asian_m, asian_m, sep = "_") %>% 
  unite(asian_f, gat_asian_f, asian_f, sep = "_") %>% 
  unite(asian, asian_m, asian_f, sep = "/") %>% 
  pivot_longer(c("asian"), 
               names_to = "race", values_to = "count") %>% # pivot columns
  separate(count, into = c("male", "female"), sep = "/") %>% 
  pivot_longer(c("male", "female"), 
               names_to = "sex", values_to = "count") %>% 
  separate(count, into = c("gat_count", "race_sex_count"), sep = "_")
...
ggplot(by_state, aes(state, bipoc_white_ratio)) +
